...
const Counter = () => {
    ...
    // when we used array clicked is doesn't work
  ...
  return (
    <div className="m-10 border border-slate-300 rounded-md p-4 flex flex-col gap-4 items-center w-fit">
        ...
        <div className="mt-4">
          <p> {on ? 'switch on ' : 'switch of'}</p>
           <button onClick={toogle} className="bg-slate-800 text-white px-4 py-2 rounded-md cursor-pointer">
           toogle
           </button>
        </div>
    </div>
